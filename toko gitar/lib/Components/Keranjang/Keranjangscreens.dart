...
class _KerangjangScreens extends State<KerangjangScreens> {
        ...
        isLoading
            ...
            : ListView(
                ...
                children: <Widget>[
                  ListView.separated(
                    itemCount:
                        dataKeranjang == null ? 0 : dataKeranjang.length,
                    shrinkWrap: true,
                    primary: false,
                    ...
                    itemBuilder: (context, index) {
                      return _keranjang(
                        "$baseUrl/gambar-barang/${dataKeranjang[index]['barang']['gambar']}",
                        dataKeranjang[index]['barang']['namaBarang'],
                        dataKeranjang[index]['barang']['harga'],
                        dataKeranjang[index]['jumlahBeli'],
                        index,
                        dataKeranjang[index]['_id'],
                      );
                    },
                  ),
  ...
  Widget _keranjang(
    ...
    dataKeranjang[index]['subtotal'] = subTotal;
    return FadeInDown(
      ...
      setState(() {
        ...
        if (status == true) {
          ...
          for (var i = 0; i < dataKeranjang.length; i++) {
            print(dataKeranjang[i]['jumlahBeli']);
            int jmlBeli = dataKeranjang[i]['jumlahBeli'];
            int harga = dataKeranjang[i]['barang']['harga'];
            total += jmlBeli * harga;
          }
        } else {
          AwesomeDialog(
